        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-center">
              <div className="bg-blue-700 text-white w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6">
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="bg-white rounded-lg shadow-md p-8 border-t-4 border-blue-300">
              ...
              <ul className="space-y-3 mb-8">
                <li className="flex items-center">
                  <svg className="w-5 h-5 text-blue-700 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 border-t-4 border-blue-700 transform scale-105 z-10">
              <div className="absolute top-0 right-0 bg-blue-700 text-white text-xs uppercase font-semibold py-1 px-2 rounded-bl">Popular</div>
      ...
      <section className="py-20 px-4 bg-blue-700 text-white">
        <div className="container mx-auto text-center">
          ...
          <Button 
            asChild
            size="lg"
            className="btn btn-primary bg-white text-blue-700 hover:bg-gray-100">
            <Link href="/contact">
              Contact Us Today
            </Link>
          </Button>          
